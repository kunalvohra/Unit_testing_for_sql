...
def setup_framework():
    ...
    print("\n🚀 Setting up FULL SQL Test Framework...\n")
...
""")
    ...
    # ============================================================
    # utils/assertions.py (numeric tolerant)
    # ============================================================
...
# ============================================================
# generator/generate_framework.py (with blank-CSV creation)
# ============================================================
    generator_code = r'''
import os
import sys
...
# ============================================================
    ...
    print("---------------------------------------------------")
    print("Next steps:")
    print("1️⃣  Put SQL files anywhere OR inside ./sql/")
    print("2️⃣  Generate wrappers + tests:")
    print("       python generator/generate_framework.py --scan-all")
    print("       OR")
    print("       python generator/generate_framework.py --sql-root sql")
    print("")
    print("3️⃣  Populate test_data/<module_key>/ with:")
    print("       - <table>.csv (auto-created blank)")
    print("       - <table>_caseX.csv (optional case inputs)")
    print("       - expected_default.csv")
    print("       - expected_<caseid>.csv")
    print("")
    print("4️⃣  Run tests:")
    print("       pytest -q")
    print("")
    print("5️⃣  Coverage (HTML + XML for CI/CD):")
    print("       pytest --cov=wrappers --cov=utils --cov-report=html --cov-report=xml")
    print("---------------------------------------------------\n")
