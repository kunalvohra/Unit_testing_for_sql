...
from wrappers.pipelines_sales_join_products import run_pipelines_sales_join_products
...
def test_pipelines_sales_join_products_bundle(spark, caseid, mapping):
    ...
    actual = run_pipelines_sales_join_products(spark)
    ...
    assert_df_equal(actual, expected, msg=f'pipelines_sales_join_products - {caseid}')
